...
PROMPT='%{$fg[red]%}┌[ %{$fg_bold[green]%}%m%{$fg_no_bold[red]%}::%{$fg_no_bold[green]%}%n% %{$fg[red]%} [%{$fg_bold[white]%}%3~%{$fg_no_bold[red]%}]$(git_prompt_info)
%{$fg_no_bold[red]%}└[%{$fg[red]%} ➤ %{$reset_color%}'
RPROMPT='[%*]'
